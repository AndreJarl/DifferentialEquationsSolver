...
function Hero(){
    return (
        <>
        <div className="lg:-mt-4 sm:mt-16 mx-10 flex justify-center items-center">
            <div className="flex justify-center items-center gap-4 flex-row sm:flex-col mb-5">
                <div className="flex gap-5 lg:flex-row sm:flex-col justify-center items-center">
                  <div className="flex sm:flex-col justify-center items-center gap-3">
                        ...
                        <p className="text-center lg:mx-9 sm:mx-4 sm:pb-2 text-lg font-semibold text-gray-500">Classications, Elimination of Arbitrary Constants, Application of Seperable Variable and many more.....</p>
